...
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, Metadata, error) {
	// to_tsvector converts the title of existing movies to lexemes
	// plainto_tsquery converts the search term to a query, consisting of the lexemes
	// @@ will return rows, where all the query terms are present in the row's lexemes
	query := fmt.Sprintf(`
